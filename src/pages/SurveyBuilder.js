...
class SurveyBuilder extends React.Component{
    ...
    constructor(props){
        ...
        this.showQuestionTypes = this.showQuestionTypes.bind(this)
    }
                        ...
                        <div  key={i} className="max-w rounded overflow-hidden shadow-lg bg-white mt-8">
                            <div className="px-6 py-4">
                                ...
                                <table className="w-full table-auto rounded-sm mt-5">
                                    <thead>
                                        <tr>
                                            <th key={i} className="px-4 py-4 text-left bg-[#62c5e5] text-black 
                                                text-sm  font-medium">
                                            </th> 
                                            {headers.map((header,i)=>{
                                                return <th key={i} className="px-4 py-4 text-left bg-[#62c5e5] text-black 
                                                        text-sm  font-medium">
                                                            {header}
                                                        </th> 
                                            })}
